...
----------------------------------------------------------------------------
--  Name......: 50_create_lockdown_profiles_12.2.sql
--  Author....: Stefan Oehrli (oes) stefan.oehrli@trivadis.com
--  Editor....: Stefan Oehrli
--  Date......: 2019.12.03
--  Usage.....: @50_create_lockdown_profiles_12.2
--  Purpose...: Script to create lockdown profiles for 12.2
--  Notes.....: 
--  Reference.: 
...
CREATE LOCKDOWN PROFILE tvd_default;
PAUSE
---------------------------------------------------------------------------
...
ALTER LOCKDOWN PROFILE tvd_default DISABLE STATEMENT = ('ALTER SYSTEM');
...
---------------------------------------------------------------------------
-- 50_create_lockdown_profiles_12.2.sql : finished
---------------------------------------------------------------------------
SET ECHO OFF
-- EOF ---------------------------------------------------------------------
