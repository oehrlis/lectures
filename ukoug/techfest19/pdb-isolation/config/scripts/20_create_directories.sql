...
--  Purpose...: Script to create directories
--  Notes.....: 
--  Reference.: 
...
---------------------------------------------------------------------------
-- Check PATH_PREFIX in database_properties
...
---------------------------------------------------------------------------
-- create directory in a ..
CREATE OR REPLACE DIRECTORY up_dir AS '../test';
PAUSE
---------------------------------------------------------------------------
-- check the current directories
SELECT directory_name, directory_path FROM dba_directories
WHERE origin_con_id=(SELECT con_id FROM v$pdbs where name=upper('&pdb_db_name'));
PAUSE

---------------------------------------------------------------------------
-- verify the directories with HOST ls -al
-- CREATE DIRECTORY does not create folders on OS!
host ls -al /u01/oradata/PDBSEC/directories
